...
More reporting views (filters, grouping, charts)

Import from other trackers

Authentication / multi-user support (if relevant)
Contributing
(TODO: Contribution guidelines, how to run tests/lint, PR process.)
License
(TODO: Add license type and/or a LICENSE file.)
